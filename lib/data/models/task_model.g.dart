...
void _taskModelSerialize(
  ...
  writer.writeLong(offsets[3], object.estimatedDurationMinutes);
  ...
  writer.writeLong(offsets[8], object.statusValue);
...
TaskModel _taskModelDeserialize(
  ...
  object.estimatedDurationMinutes = reader.readLong(offsets[3]);
  object.id = id;
  ...
  object.statusValue = reader.readLong(offsets[8]);
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> statusValueEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> statusValueLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> statusValueBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByStatusValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'statusValue', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByStatusValueDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByStatusValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'statusValue', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByStatusValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'statusValue', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByStatusValue() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, int, QQueryOperations> statusValueProperty() {
    return QueryBuilder.apply(this, (query) {
